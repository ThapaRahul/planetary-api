...
app.config['JWT_SECRET_KEY'] = 'super-secret'   # this needs to be changed to a secure one
app.config['MAIL_SERVER']='smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = '50fe56f1156846'
app.config['MAIL_PASSWORD'] = 'eddd498d1ca2ae'
